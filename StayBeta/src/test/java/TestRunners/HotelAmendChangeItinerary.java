...
@CucumberOptions(features = "src/test/java/RegressionSuite/Hotel - Amend - ChangeItinerary.feature",plugin = {
...
public class HotelAmendChangeItinerary extends AbstractTestNGCucumberTests {
