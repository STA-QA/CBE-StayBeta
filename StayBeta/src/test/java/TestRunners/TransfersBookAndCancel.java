...
@CucumberOptions(features = "src/test/java/RegressionSuite/Transfers - Cancellations.feature",plugin = {
...
public class TransfersBookAndCancel extends AbstractTestNGCucumberTests {
