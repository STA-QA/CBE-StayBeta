...
@CucumberOptions(features = "src/test/java/RegressionSuite/ExpediaHotelBooking.feature", plugin = {
		"com.vimalselvam.cucumber.listener.ExtentCucumberFormatter:","rerun:target/rerun.txt" }, glue = "stepDefinitions")


public class ExpediaHotelBookingRunner extends AbstractTestNGCucumberTests {
