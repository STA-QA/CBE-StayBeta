...
Scenario Outline: User Book a hotel through <Data Source> and Change itinerary through Amend Option for GB 
    ...
    Examples: 
      ...
      | Dubai (DXB), United Arab Emirates (AE) | DXB          | Arabian Adventures | 32       | 2          | 1     | 2      | 0        | 0           | Outside   | 31          | 3             | 
      | Dubai (DXB), United Arab Emirates (AE) | DXB          | Arabian Adventures | 32       | 2          | 1     | 2      | 0        | 0           | Outside   | 2           | 2             | 
...
Then Get updated Booking Details 
    ...
    Examples: 
      | Country                                | SearchString | DataSource         | StartDay | NoOfNights | Rooms | Adults | Children | ChildrenAge | Condition | NewStartDay | NewNoOfNights | 
      | Dubai (DXB), United Arab Emirates (AE) | DXB          | Arabian Adventures | 40       | 2          | 1     | 2      | 0        | 0           | Outside   | 21          | 1             | 
      | Dubai (DXB), United Arab Emirates (AE) | DXB          | Arabian Adventures | 40       | 2          | 1     | 2      | 0        | 0           | Outside   | 6           | 2             | 
      | Dubai (DXB), United Arab Emirates (AE) | DXB          | Arabian Adventures | 15       | 2          | 1     | 2      | 0        | 0           | Outside   | 20          | 2             | 
